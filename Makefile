...
ACLOCAL = ${SHELL} /usr/src/openvswitch-2.7.4/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /usr/src/openvswitch-2.7.4/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /usr/src/openvswitch-2.7.4/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /usr/src/openvswitch-2.7.4/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /usr/src/openvswitch-2.7.4/build-aux/missing automake-1.15
AWK = mawk
CAPNG_LDADD = 
...
DEPDIR = .deps
DLLTOOL = false
DPDK_vswitchd_LDFLAGS = -Wl,--whole-archive,-ldpdk,--no-whole-archive
DSYMUTIL = 
DUMPBIN = 
ECHO_C = 
ECHO_N = -n
...
LDFLAGS = 
LIBOBJS = 
LIBS = -ldpdk -ldl -latomic -lpthread -lrt -lm  
...
LT_REVISION = 0
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /usr/src/openvswitch-2.7.4/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MSVC64_LDFLAGS = 
MSVC_CFLAGS = 
...
OTOOL = 
OTOOL64 = 
OVS_CFLAGS =  -I/usr/src/dpdk-stable-16.11.5//x86_64-native-linuxapp-gcc/include
OVS_LDFLAGS =  -L/usr/src/dpdk-stable-16.11.5//x86_64-native-linuxapp-gcc/lib
OVS_LTINFO = -release 2.7 -version-info 1:4
PACKAGE = openvswitch
PACKAGE_BUGREPORT = bugs@openvswitch.org
PACKAGE_NAME = openvswitch
PACKAGE_STRING = openvswitch 2.7.4
...
PYTHON = ${SHELL} /usr/src/openvswitch-2.7.4/build-aux/missing python
...
abs_builddir = /usr/src/openvswitch-2.7.4
abs_srcdir = /usr/src/openvswitch-2.7.4
abs_top_builddir = /usr/src/openvswitch-2.7.4
abs_top_srcdir = /usr/src/openvswitch-2.7.4
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /usr/src/openvswitch-2.7.4/build-aux/install-sh
